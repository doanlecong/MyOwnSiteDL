...
<head>
    ...
    <title>{{ config('app.name', 'My Own Site | Doan Le') }}</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-primary navbar-laravel navbar-under-top sticky-top">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img class="img-fluid logo-full-size" src="{{ asset('upload/images/logo.png')}}">
            </a>
            <a class="navbar-brand slogan-title" href="{{ url('/') }}">
                <h4>Háy sống với đam mê.</h4>
            </a>
