        ...
        <div class="card card-no-border">
            ...
            <div class="card-body no-padding-left-right no-padding-top background-blue ">
                <div class="row mt-3 background-white padding-top-10 no-margin-top">
                    <div class="col ">
                        <form action="{{ route('mypost.updatePost',['type' => $type, 'id' => $myPost->id ]) }}"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input class="form-control " name="title" id="title" data-ok="Y" required
                                                   max="255" value="{{ $myPost->title }}">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control " name="slug" id="slug" data-ok="Y" required
                                                   max="255" value="{{ $myPost->slug }}">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <textarea class="form-control" name="description" rows="5"
                                                      id="mota"
                                                      required>{{ strip_tags($myPost->description) }}</textarea>
                                                    ...
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="savetype"
                                                                   {{ $myPost->status == "N" ? "checked" : "" }} value="N">
                                                            Lưu Nháp
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio"
                                                                   {{ $myPost->status == "Y" ? "checked" : "" }} name="savetype"
                                                                   value="Y"> Lưu hoàn chỉnh &amp xuất bản</label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-9 no-padding-right">
                                                    <label for="tags">Tags :</label>
                                                    <select class="form-control" name="tags[]" style="height: 200px;"
                                                            id="tagsSelect" multiple>
                                                        @foreach($tags as $t)
                                                            @if(in_array($t->id, $arrTagSelected))
                                                                <option selected value="{{$t->id}}">{{$t->abbrev}}
                                                                    --{{$t->name}}--Type
                                                                    : {{ $typeTags[$t->type_tag] }}</option>
                                                            @else
                                                                <option value="{{$t->id}}">{{$t->abbrev}}--{{$t->name}}
                                                                    --Type : {{ $typeTags[$t->type_tag] }}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-control" required name="my_topic_id"
                                                    style="height: 50px;">
                                                <option style="background-color: #ff4879;" class="text-light" value="">
                                                    Chọn một chủ đề
                                                </option>
                                                @foreach($topics as $tp)
                                                    @if($tp->id == $myPost->my_topics_id )
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <input id="hinhdaidien" class="form-control" type="text"
                                                       name="hinhdaidien" value="{{ $myPost->hinhdaidien }}">
                                            </div>
                                            <img id="holder" src="{{ $myPost->hinhdaidien }}"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <textarea class="form-control" name="contentPost" id="contentPost"
                                                          rows="5"
                                                          required>{{ $myPost->content }}</textarea>
                                            </div>
                                        </div>
