...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Dashboard Blog</li>
        </ol>
    </nav>
@endsection
...
@section('contentAdmin')
    <div class="col-lg no-padding-left-right">
        <div class="card card-no-border">
            <div class="card-header card_header_gradient no-border-radius">Danh Sách Các Bài Blog</div>
            <div class="card-body no-padding-left-right padding-top-10 background-blue ">
                        ...
                        <div class="card card-no-border box-shadown-darkblue no-border-radius">
                            <div class="card-body no-padding-left-right no-padding-bottom padding-top-10">
                                ...
                                <div class="haft-right padding-leftright-10">
                                    ...
                                    <p class="text-left dichvu_slogan text-20 text-primary no-margin-bottom">
                                        {{ $countPublishBlog }}
                                        <small> bài đã xuất bản</small> ||
                                        {{ $countUnpublishBlog }}
                                        <small> đang viết dở</small>
                                    </p>
                                </div>
                ...
                <div class="row mt-3 background-white padding-top-30 border-top-blue">
                    <div class="col ">
                        <p>
                            <a href="{{ route('mypost.writepost',['type' => $typeBlog]) }}"
                ...
                <div class="row mt-3 background-white padding-top-30 border-top-blue" id="viewPostHidden" hidden="true">
    ...
    <script>
        ...
        $(document).ready(function () {
            $.ajax({
                "async": true,
                "crossDomain": true,
                "url": "{{ route('mypost.tablePost',['typepost' => $typeBlog, 'ispublic' => $publish]) }}",
                "method": "GET",
            }).done(function (data) {
            ...
            $.ajax({
                "async": true,
                "crossDomain": true,
                "url": "{{ route('mypost.tablePost',['typepost' => $typeBlog, 'ispublic' => $unPublish]) }}",
                "method": "GET",
            }).done(function (data) {
