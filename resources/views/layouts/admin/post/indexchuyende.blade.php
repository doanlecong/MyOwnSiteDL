...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Dashboard Chuyên Đề</li>
        </ol>
    </nav>
@endsection
...
@section('contentAdmin')
    <div class="col-lg no-padding-left-right">
        <div class="card card-no-border">
            <div class="card-header card_header_gradient no-border-radius">Danh Sách Chuyên Đề</div>
            <div class="card-body no-padding-left-right padding-top-10 background-blue ">
                        ...
                        <div class="card card-no-border box-shadown-darkblue no-border-radius">
                            <div class="card-body no-padding-left-right no-padding-bottom padding-top-10">
                                ...
                                <div class="haft-right padding-leftright-10">
                                    ...
                                    <p class="text-left dichvu_slogan text-primary text-20 no-margin-bottom">
                                        <span>{{ $countPublishChuyende }}
                                            <small> bài đã xuất bản</small></span> ||
                                        <span>{{ $countUnpublishChuyende }}
                ...
                <div class="row mt-3 background-white padding-top-30 border-top-blue">
                    <div class="col">
                        <p>
                            <a href="{{ route('mypost.writepost',['type'=> $typeChuyende]) }}"
                               class="btn btn-warning  box-shadown-darkblue"><i class="fa fa-pencil-square-o"
                                                                                aria-hidden="true"></i> Viết bài mới</a>
                        </p>
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item box-shadown-darkblue no-border-radius">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#topicchuyende"
                                   role="tab"
                            ...
                            <li class="nav-item box-shadown-darkblue no-border-radius">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#unpublishchuyende"
                                   role="tab"
                                   aria-controls="profile" aria-selected="false"><i class="fa fa-pause" aria-hidden="true"></i> Bài đang viết dở</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="topicchuyende" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="unpublishchuyende" role="tabpanel"
                                 aria-labelledby="profile-tab">
                                <div class="wrapper-for-loading padding-top-30 padding-bottom-10    ">
                                    <div class="loader"></div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $.ajax({
                "async": true,
                "crossDomain": true,
                "url": "{{ route('mypost.tablePost',['typepost' => $typeChuyende, 'ispublic' => $publish]) }}",
                "method": "GET",
            }).done(function (data) {
            ...
            $.ajax({
                "async": true,
                "crossDomain": true,
                "url": "{{ route('mypost.tablePost',['typepost' => $typeChuyende, 'ispublic' => $unPublish]) }}",
                "method": "GET",
            }).done(function (data) {
