            ...
            <div class="col-sm-12 col-md-4 border-around-blue">
                @if($newestPost != null)
                    <div>
                        ...
                        <a href="{{ route('chuyende.showBaiViet',$newestPost->slug.".html") }}"
                ...
                @if(count($topics) >= 2)
                    ...
                    <div>
                        @foreach($topics as $tp)
                            @if($tp->id != $topic->id)
                                <h5 class="text-left text-primary font-roboto-light"><a class="animate-bottom-nocontent" href="{{ route('chuyende.showTopic',$tp->slug.'.html') }}">{{$tp->title}}</a></h5>
                            @endif
                        @endforeach
                    </div>
                        ...
                        <div class="row mb-2 padding-top-10 border-around-blue padding-bottom-10">
                            ...
                            <div class="col-sm-8">
                                <h4 class="text-left font-roboto-light">
                                    <a class="animate-bottom" href="{{ route('chuyende.showBaiViet',$post->slug.".html") }}">{{ $post->title }}</a>
                                </h4>
