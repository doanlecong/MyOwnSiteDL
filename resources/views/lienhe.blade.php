            ...
            <div class="padding-around">
                <form>
                    <div class="form-group">
                        <label for="name">Tên của bạn<span class="text-xl-center">*</span> : </label>
                    ...
                    <div class="row" >
                        <div class="col-sm">
                            <div class="form-group">
                                <label for="email">Email của bạn <span class="text-xl-center">*</span> :</label>
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                <label for="email1">Xác nhận email <span class="text-xl-center">*</span> :</label>
                    ...
                    <div class="form-group">
                        <label for="content">Nội dung <span class="text-xl-center">*</span> :</label>
