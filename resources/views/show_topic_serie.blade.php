...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="{{route('myblog')}}">My Serie</a></li>
    ...
    <div class="container border-top-blue no-padding-left-right no-padding-top">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8">
                <h4 class="text-left text-primary font-roboto-light"><i class="fa fa-book" aria-hidden="true"></i> Bài trước đó</h4>
