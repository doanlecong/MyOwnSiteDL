    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <a href="{{route('chuyende.showTopic',$post->topic->slug.".html")}}">{{ mb_substr($post->topic->title, 0, 20) }}</a>
            </li>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-9">
                <div class="contentPost container content-post-show" id="contentPost">
                    ...
                    <span class="text-20 blue-text"><i class="fa fa-eye blue-text"></i> {{ $count }}</span> @@@@ &nbsp;
                    <span><a href="{{ request()->url() }}#disqus_thread">0 Comments</a></span>
                    <p>
                        @foreach($post->tags as $tag)
            ...
            <div class="col-sm-12 col-md-3 border-around-blue">
                @foreach($previousPosts as $previousPost)
                    <div class="padding-leftright-10 padding-top-10 padding-bottom-10">
                        ...
                        <h4 class="text-left font-roboto-light animate-bottom-nocontent">
                            <a href="{{ route('chuyende.showBaiViet',$previousPost->slug.".html") }}">{{ $previousPost->title }}</a>
                        </h4>
                        ...
                        <a href="{{ route('chuyende.showBaiViet',$previousPost->slug.".html") }}"
                ...
                @foreach($forwardPosts as $forwardPost)
                    <div class="padding-leftright-10 padding-top-10 padding-bottom-10">
                        ...
                        <a href="{{ route('chuyende.showBaiViet',$forwardPost->slug.".html") }}"
                           class="btn btn-primary text-light no-border-radius out-line-blue">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                            Xem Típ
                        </a>
